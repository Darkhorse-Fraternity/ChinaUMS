...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder usingActivityIndicatorStyle:(UIActivityIndicatorViewStyle)activityStye {
    [self setImageWithURL:url placeholderImage:placeholder options:SDWebImageHandleCookies progress:nil completed:nil usingActivityIndicatorStyle:activityStye];
}
