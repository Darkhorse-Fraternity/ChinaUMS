...
#define IOS8  IOS_VERSION>=8.f
#define IOS7  IOS_VERSION>=7.f
#define IOS6  IOS_VERSION<7.f
...
#define MYSTORYBOARD(Identifier)\
[[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:Identifier];
